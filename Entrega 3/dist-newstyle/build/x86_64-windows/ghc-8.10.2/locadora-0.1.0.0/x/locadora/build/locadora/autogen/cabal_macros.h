...
/* package locadora-0.1.0.0 */
#ifndef VERSION_locadora
#define VERSION_locadora "0.1.0.0"
#endif /* VERSION_locadora */
#ifndef MIN_VERSION_locadora
#define MIN_VERSION_locadora(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_locadora */
...
/* package HDBC-postgresql-2.4.0.0 */
#ifndef VERSION_HDBC_postgresql
#define VERSION_HDBC_postgresql "2.4.0.0"
...
#define CURRENT_COMPONENT_ID "locadora-0.1.0.0-inplace-locadora"
